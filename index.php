    ...
    <nav class="navbar-color">
        <div class="nav-wrapper">
            <ul class="left">
                ...
                <li><a href="#"><img src="images\sujallogo.png" style="height: 64px;"></a></li>
            </ul>
            <ul class="right hide-on-med-and-down">
                <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money"><?php echo Sujal;?></i></a></li>
                <li><a href="routers/logout.php" class="waves-effect waves-block waves-light"><i class="mdi-hardware-keyboard-tab"></i> Logout</a></li>
            </ul>
        </div>
    </nav>
</div>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="feedback.php" class="waves-effect waves-cyan"><i class="mdi mdi-comment-quote"></i> Feedback</a>
            </li>				
        </ul>
